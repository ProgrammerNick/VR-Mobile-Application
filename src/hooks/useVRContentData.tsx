...
export function useVRContentData() {
  ...
  const [contentDetails, setContentDetails] = useState<Record<string, VRContentDetails>>({
    '1': {
      id: '1',
      ...
      totalRatings: 453,
      price: 12.99,
      thumbnails: ['https://images.unsplash.com/photo-1518709268805-4e9042af2176?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjeWJlcnB1bmslMjBjaXR5fGVufDF8fHx8MTc1NjM1NzIxNHww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral'],
      features: [
      ...
      reviews: [
        {
          ...
          username: 'CyberNinja',
          rating: 5,
          comment: 'Absolutely mind-blowing! The atmosphere is incredible and the story had me hooked from start to finish.',
          date: '1 week ago',
          helpful: 42
        },
        {
          ...
          rating: 5,
          comment: 'Best cyberpunk VR experience I\'ve tried. The attention to detail in the environment is phenomenal.',
          date: '4 days ago',
          helpful: 38
        },
        {
          ...
          username: 'SciFiFan',
          rating: 4,
          comment: 'Great visuals and sound design. Some minor performance issues but overall fantastic experience.',
          date: '2 weeks ago',
          helpful: 27
        }
      ]
    ...
    '2': {
      ...
      totalRatings: 321,
      price: 9.99,
      thumbnails: ['https://images.unsplash.com/photo-1451187580459-43490279c0fa?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlYXJ0aCUyMGZyb20lMjBzcGFjZXxlbnwxfHx8fDE3NTYzNTcyMTR8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral'],
      features: [
      ...
      reviews: [
        {
          ...
          rating: 5,
          comment: 'Incredible experience! As close as I\'ll get to being an astronaut. The Earth views are breathtaking.',
          date: '5 days ago',
          helpful: 33
        },
        {
          ...
          rating: 4,
          comment: 'Perfect for teaching space science. Students are completely engaged when using this.',
          date: '1 week ago',
          helpful: 28
        },
        {
          ...
          username: 'VRExplorer',
          rating: 5,
          comment: 'The zero gravity movement feels so realistic. Great attention to scientific accuracy.',
          date: '3 days ago',
          helpful: 21
        }
      ]
    ...
    'fallback-1': {
      ...
      rating: 4.3,
      totalRatings: 289,
      thumbnails: ['https://images.unsplash.com/photo-1547930206-82ac0a7aa08d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhYnN0cmFjdCUyMGRpZ2l0YWwlMjB3b3JsZHxlbnwxfHx8fDE3NTYzNTcyMTR8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral'],
      features: [
      ...
      reviews: [
        {
          ...
          username: 'VRNewbie',
          rating: 5,
          comment: 'Perfect introduction to VR! The tutorial is very well structured and helped me get comfortable with the technology quickly.',
          date: '2 weeks ago',
          helpful: 23
        },
        {
          ...
          rating: 4,
          comment: 'Great for beginners. My kids loved it too. The hand tracking tutorial was especially helpful.',
          date: '1 month ago',
          helpful: 15
        }
      ]
    ...
    '3': {
      ...
      totalRatings: 876,
      price: 14.99,
      thumbnails: ['https://images.unsplash.com/photo-1552832230-c0197dd311b5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb2xvc3NldW0lMjByb21lfGVufDF8fHx8MTc1NjM1NzIxNHww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral'],
      features: [
      ...
      reviews: [
        {
          ...
          rating: 5,
          comment: 'Absolutely incredible! As a history teacher, this is exactly what I needed. The attention to detail is phenomenal.',
          date: '1 week ago',
          helpful: 45
        },
        {
          ...
          username: 'RomanFan',
          rating: 5,
          comment: 'Felt like I was actually there. The gladiator fights gave me chills!',
          date: '3 days ago',
          helpful: 28
        },
        {
          ...
          username: 'EduTech',
          rating: 4,
          comment: 'Great educational value. Using this in my classroom. Students are engaged like never before.',
          date: '2 weeks ago',
          helpful: 22
        }
      ]
    ...
    '4': {
      ...
      totalRatings: 492,
      price: 11.99,
      thumbnails: ['https://images.unsplash.com/photo-1559827260-dc66d52bef19?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb3JhbCUyMHJlZWZ8ZW58MXx8fHwxNzU2MzU3MjE0fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral'],
      features: [
      ...
      reviews: [
        {
          ...
          rating: 5,
          comment: 'Breathtaking! I felt like I was actually swimming with whales. The visuals are stunning.',
          date: '5 days ago',
          helpful: 18
        },
        {
          ...
          username: 'ScubaSteve',
          rating: 4,
          comment: 'As a real diver, this captures the magic of being underwater perfectly. Great for those who can\'t dive.',
          date: '1 week ago',
          helpful: 12
        }
      ]
    ...
    '5': {
      ...
      description: 'Experience the energy of a live concert from the front row.',
      ...
      totalRatings: 634,
      price: 8.99,
      thumbnails: ['https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmZXN0aXZhbCUyMGNyb3dkfGVufDF8fHx8MTc1NjM1NzIxNHww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral'],
      features: [
      ...
      screenshots: [
        'https://images.unsplash.com/photo-1636036704268-017faa3b6557?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxnYW1pbmclMjBlbnZpcm9ubWVudCUyMG5lb258ZW58MXx8fHwxNzU2MzU3MjE0fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
        'https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtdXNpYyUyMGNvbmNlcnQlMjBzdGFnZXxlbnwxfHx8fDE3NTYzNTcyMTR8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral'
      ],
      reviews: [
        {
          id: '9',
          username: 'MusicFan',
          rating: 5,
          comment: 'This is the closest thing to being at a real festival! The energy is infectious.',
          date: '4 days ago',
          helpful: 25
        },
        {
          ...
          username: 'RockOn',
          rating: 4,
          comment: 'Great way to experience live music when you can\'t make it to actual concerts. The sound quality is excellent.',
          date: '1 week ago',
          helpful: 16
        }
      ]
    ...
    'new-1': {
      ...
      totalRatings: 543,
      price: 12.99,
      thumbnails: ['https://images.unsplash.com/photo-1516849841032-87cbac4d88f7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhc3Ryb25hdXQlMjBzcGFjZXxlbnwxfHx8fDE3NTYzNTcyMTR8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral'],
      features: [
      ...
      reviews: [
        {
          ...
          rating: 5,
          comment: 'This is the closest I\'ll ever get to being an astronaut! The detail is incredible and the spacewalk was breathtaking.',
          date: '1 week ago',
          helpful: 34
        },
        {
          ...
          rating: 5,
          comment: 'Perfect educational tool for teaching about space exploration. My students were amazed!',
          date: '2 weeks ago',
          helpful: 21
        }
      ]
    ...
    'new-2': {
      ...
      totalRatings: 289,
      price: 9.99,
      thumbnails: ['https://images.unsplash.com/photo-1587854692152-cbe660dbde88?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcmVoaXN0b3JpYyUyMGZvcmVzdHxlbnwxfHx8fDE3NTYzNTcyMTR8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral'],
      features: [
      ...
      fileSize: '6.1 GB',
      screenshots: [
        'https://images.unsplash.com/photo-1616210587204-3e67e30f5615?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkaW5vc2F1ciUyMGZvcmVzdCUyMHByZWhpc3RvcmljfGVufDF8fHx8MTc1NjM2MTI5M3ww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
        'https://images.unsplash.com/photo-1578662996442-48f60103fc96?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0eXJhbm5vc2F1cnVzJTIwcmV4fGVufDF8fHx8MTc1NjM1NzIxNHww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral'
      ],
      reviews: [
        {
          id: '13',
          username: 'DinoFan',
          rating: 5,
          comment: 'Absolutely amazing! The T-Rex encounter had my heart racing. My kids love it too.',
          date: '3 days ago',
          helpful: 19
        },
        {
          ...
          username: 'PaleoNerd',
          rating: 4,
          comment: 'Great attention to scientific detail. The feathered raptors were a nice touch!',
          date: '1 week ago',
          helpful: 13
        }
      ]
