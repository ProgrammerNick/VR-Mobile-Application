...
COMMENT ON TABLE "public"."achievements" IS 'Stores all possible achievements for each game.';
...
COMMENT ON TABLE "public"."user_achievements" IS 'Tracks which achievements have been unlocked by which users.';
